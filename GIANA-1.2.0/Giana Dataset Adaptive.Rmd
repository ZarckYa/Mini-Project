...
VDJdb_TRA_human <- read.csv('VDJdb_TRA_human_fix.csv')


indir <- 'D:/Master in UoB/TB2 of UoB/Mini Project/vdjdb-2022-03-30/vdjdb.txt'
#indir <- 'D:/Master in UoB/TB2 of UoB/Mini Project/GIANA/GIANA-1.2.0/VDJdb_TRA_human_fix.csv'
outdir <- 'D:/Master in UoB/TB2 of UoB/Mini Project/GIANA/GIANA-1.2.0'
ffs=dir(indir,full.names=T)

#PrepareAdaptiveFile(indir, outdir)
